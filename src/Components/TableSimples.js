...
function TableSimples({ columns, data, length = 10, showFilter = true, showMenu = true, showFilterStats = true}) {
    ...
    return (
        <>
            <div className="row">
                <div className={`col-md-4 ${showMenu ? '' : 'd-none'}`}>
                ...
                <div className={`${showFilter ? '' : 'd-none'} ${showFilterStats ? 'col-md-8' : 'col-md-3 offset-md-6'}`}>
