                        ...
                        Cell: ({ cell: { value }, row: { original } }) => (
                            <Link to={`/editar-usuario/${original.id}`} className="d-flex flex-column align-items-start">
                                ...
                                <div className="d-flex align-items-center me-1">
                                    ...
                                    <div className={`badge bg-secondary ms-1 ${original.whatsapp ? '' : 'd-none'}`}><Link className='text-dark' to={`http://wa.me/55${original.whatsapp}`} target='_blank'><i class="bi bi-whatsapp"></i> {original.whatsapp || '-'}</Link></div>
                                </div>
                            </Link>
                        ),
                    },
